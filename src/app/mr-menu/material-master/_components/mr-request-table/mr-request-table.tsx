...
interface MRMasterProps {
  data: MRMasterSchema[];
  columns: ColumnDef<MRMasterSchema>[];
  onAddData: (newData: MRMasterSchema) => void;
}

export default function MRMaster({ data, columns, onAddData }: MRMasterProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
        ...
        <MRCreateForm onAddData={onAddData} />
      </div>
